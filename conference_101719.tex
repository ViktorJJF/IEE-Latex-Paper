...
\author{\IEEEauthorblockN{1\textsuperscript{st} Víctor Juan Jimenez Flores}
    ...
    % asociacion peruana de investigación, ciencia y tecnología comprar dominio antes de enviar paper
    \and
...
\begin{abstract}
    The aim of this paper is to comparing the main natural language understanding services through F1 Score and confusion matrix.
...
\begin{IEEEkeywords}
    chatbot, NLU Services
\end{IEEEkeywords}

\section{Introduction}

Como dice \cite{Brooke1996} \cite{Khanna2015}. Una definicion de los chatbots es lo que dice \cite{singh2019building} y que concuerda con cite  This \cite{coelloFinanzasCorporativasValor2017} document is a model and instructions for \LaTeX.
...
\begin{table}[htbp]
    ...
    \begin{center}
        \begin{tabular}{|c|c|c|c|}
            ...
            \hline
            copy                & More table copy$^{\mathrm{a}}$                   & aea                       & mas contenido             \\
            \hline
...
Esto es un texto simple como se indico en \ref{tab1} en la pagina \pageref{tab1}
...
\subsection{Testing graphic}
\begin{figure}[htbp]
    \centerline{\includegraphics[width=8cm, height=6cm]{Images/chatbot.png}}
    \caption{Los chatbots en la actualidad}
    \label{fig}
\end{figure}
...
A continuación veré el resultado de la cita.
...
For aeaaa  papers published in translation journals, please give the English
citation first, followed by the original foreign-language citation .
\bibliographystyle{IEEEtran}
% \printbibliography
\bibliography{C:/Users/JIMENEZ/Documents/bibtex/PaperDubai.bib}
\vspace{12pt}
\color{red}
